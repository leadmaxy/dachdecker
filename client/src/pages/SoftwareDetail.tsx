...
const softwareDatabase = {
  ...
  sykasoft: {
    ...
    longDescription: "Sykasoft ist eine moderne, cloudbasierte Handwerkersoftware, die speziell für SHK-Betriebe entwickelt wurde. Mit KI-gestützten Funktionen für automatische Arbeitsbericht-Erstellung und intuitiver Bedienung bietet Sykasoft eine umfassende Lösung für digitales Arbeiten. Die Software verbindet Büro und Baustelle nahtlos und ermöglicht vollständiges mobiles Arbeiten.",
    priceRange: "ab 39 EUR/Monat",
    features: [
      "KI-gestützte Arbeitsbericht-Erstellung",
      "Cloud & Mobile App (iOS/Android)",
      "DATANORM & IDS-Connect Integration",
  ...
  baufaktura: {
    ...
    description: "Spezialisierte Bau- und SHK-Software mit starkem Fokus auf Großhandelsanbindung und Kalkulation.",
    longDescription: "BauFaktura ist eine professionelle Softwarelösung für das Bauhandwerk und SHK-Betriebe mit besonderem Schwerpunkt auf präzise Kalkulation und nahtlose Großhandelsintegration. Die Software bietet umfassende Funktionen für Auftragsabwicklung, Material- und Projektmanagement sowie Zeiterfassung. Mit über 20 Jahren Erfahrung ist BauFaktura eine bewährte Lösung für mittelständische Handwerksbetriebe.",
  ...
  tooltime: {
    ...
    longDescription: "ToolTime ist eine einfach zu bedienende Handwerkersoftware, die speziell für kleine und mittlere SHK-Betriebe entwickelt wurde. Die Cloud-basierte Lösung bietet alle wichtigen Funktionen für die tägliche Arbeit zu einem attraktiven Preis-Leistungs-Verhältnis. Mit der mobilen App können Monteure direkt von der Baustelle aus arbeiten und Daten mit dem Büro synchronisieren.",
    priceRange: "ab 29 EUR/Monat",
    features: [
      "Angebots- und Rechnungserstellung",
  ...
  mfr: {
    ...
    longDescription: "mfr ist eine cloudbasierte Field Service Management Software, die speziell für SHK-Betriebe mit starkem Außendienstfokus entwickelt wurde. Die Software bietet über 100 Funktionen in einer Plattform und zeichnet sich durch KI-gestützte Einsatzplanung und Routenoptimierung aus. Ideal für Betriebe mit 5-500 Mitarbeitern im Außendienst, die ihre Prozesse von der Angebotsstellung bis zur Rechnung digitalisieren möchten.",
    priceRange: "ab 145 EUR/Monat",
    features: [
      "KI-gestützte Einsatzplanung & Routing",
      "IDS Connect & SHK Connect Integration",
  ...
  officeon: {
    ...
    longDescription: "Bosch OfficeOn ist eine cloudbasierte Handwerkersoftware, die speziell für kleine und mittlere SHK-Betriebe entwickelt wurde. Die Software verbindet Büro und Baustelle digital und zeichnet sich durch besondere Benutzerfreundlichkeit aus. Mit der Integration von DATANORM/IDS für Großhändler-Materialien und der intuitiven mobilen App bietet OfficeOn eine schlanke, aber leistungsstarke Lösung.",
    priceRange: "ab 50 EUR/Monat",
    features: [
      "Web-App & Mobile App (iOS/Android)",
      "DATANORM/IDS-Großhändleranbindung",
  ...
  cendas: {
    ...
    longDescription: "CENDAS ist eine spezialisierte Bausoftware für SHK-Handwerksbetriebe, die von Würth unterstützt wird. Die Software digitalisiert Bauprojekte von der Planung über die Ausführung bis zur Dokumentation. Mit dem integrierten KI-Assistenten können Plankomponenten automatisch erkannt und Aufgaben erstellt werden. Ideal für Betriebe, die komplexe Bauprojekte digital managen möchten.",
  ...
  dasprogramm: {
    ...
    longDescription: "Das Programm ist eine cloudbasierte All-in-One-Handwerkersoftware, die 2025 als Testsieger (Note 1,3) ausgezeichnet wurde. Die Software bietet das beste Preis-Leistungs-Verhältnis am Markt und zeichnet sich durch KI-gestützte Funktionen wie automatische Arbeitsbericht-Erstellung aus. Ideal für Solo-Selbstständige bis mittlere SHK-Betriebe, die eine benutzerfreundliche, kosteneffiziente Lösung suchen.",
  ...
  streit: {
    ...
    longDescription: "Streit V.1 ist eine vollumfängliche ERP-Handwerkersoftware mit über 40 Jahren Markterfahrung. Die Software bietet eine komplette Lösung inklusive integrierter Finanz- und Betriebsbuchhaltung. Besonders stark ist Streit V.1 in der Großhandelsanbindung und im Wartungsmanagement. Ideal für SHK-Betriebe jeder Größe, die eine ausgereifte Komplettlösung mit allen Funktionen aus einer Hand suchen.",
    priceRange: "ab 95 EUR/Monat",
    features: [
      "Integrierte Finanzbuchhaltung",
      "IDS & SHK Connect Integration",
  ...
  hero: {
    ...
    longDescription: "HERO ist eine cloudbasierte Handwerkersoftware, die als Testsieger in mehreren Vergleichen ausgezeichnet wurde. Die Software bietet eine ausgezeichnete mobile App und starke Integration mit SHK-Großhändlern über IDS Connect und SHK Connect. Mit automatischen Preiskatalog-Updates und Echtzeit-Synchronisation ist HERO ideal für Betriebe, die Wert auf moderne, cloud-native Software legen.",
  ...
  openhandwerk: {
    ...
    longDescription: "openHandwerk ist eine cloud-basierte All-in-One-Handwerkersoftware aus Berlin mit besonderem Fokus auf SHK-Betriebe. Die Software bietet über 18 kostenlose Schnittstellen zu Großhändlern und anderen Systemen. Mit DATANORM, IDS Connect und KlarPris-Integration ermöglicht openHandwerk nahtlose Anbindung an die SHK-Branche. Ideal für Betriebe mit 1-100+ Mitarbeitern.",
  ...
  sanderdoll: {
    ...
    description: "Branchenspezialisierte SHK-Software mit starker Großhandelsanbindung.",
    longDescription: "Celsius Office von Sander & Doll ist eine spezialisierte Handwerkersoftware, die gezielt für SHK-Betriebe entwickelt wurde. Die Software zeichnet sich durch besonders starke Großhandelsanbindung über OCI/IDS-Connect aus und bietet spezielle Funktionen wie NE-Metall-Management und Wartungsintervall-Planung. Mit mobiler App und umfassenden Compliance-Funktionen ideal für professionelle SHK-Betriebe.",
    priceRange: "Preis auf Anfrage",
    features: [
      "OCI/IDS-Connect für direkte Großhändler-Bestellung",
    ...
    badges: ["Desktop", "Cloud", "SHK-Spezialist"],
    recommended: false,
